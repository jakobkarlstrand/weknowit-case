...
export default function ItemCountry({navigation, onClick, geoData}) {
...
var touchProps = {
    ...
    onPress: () => navigation.navigate("Country", {geoData:geoData}), 
    };
  ...
  return (
    <TouchableHighlight style={styles.touchable} {...touchProps}>
        <View style={styles.container}>
                ...
                <Text style={isPress ? styles.textPressed : styles.text}>{geoData.countryName}</Text>
